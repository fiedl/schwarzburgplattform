Schwarzburgplattform::Application.configure do
  ...
  config.cache_store = :redis_store, "redis://localhost:6379/0/", { expires_in: 1.week, namespace: "schwarzburgplattform_#{::STAGE}_cache" }
